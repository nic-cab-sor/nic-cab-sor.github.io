...
import myImg from "../assets/img/my_picture.png"
import '../styles/Intro.css'

function Intro() {
    return (
        <section id='intro' className="hero-section d-flex flex-column justify-content-center align-items-center p-4">
            <img src={myImg} className="hero-img" alt="My Picture">
            </img>

            <div className='hero-text d-flex flex-column gap-2 pt-2'>
                <h1 className="hero-heading fst-italic text-center m-0 p-0">NICOLE CABAYA</h1>
                ...
                <p className="text-center">Hi! I'm a <span className='fw-bold'>Software Engineer</span>, I write code to make processes easier and users <span className='fw-bold'>happier</span> — <span className='fst-italic'>one line</span> at a time.</p>
